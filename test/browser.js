...
window.addEventListener('WebComponentsReady', function() {
  ...
  document.head.innerHTML += '<link rel="import" id="el" href="/base/src/brick-form.html">';

  document.querySelector('#el').addEventListener('load', function() {

    // Create the custom element.
    var customElement = document.createElement('brick-form');
...
describe("the brick-form", function(){

  it("should be attached to the DOM", function(){
    expect(document.querySelector("brick-form")).not.to.be.null;
  });
